...
class compression {
	...
	open(opts) {
		...
		var name = "create" + upper_first(match_type(options.type));
	...
	write(chunk, encoding) {
		...
		return this._cerus.promise(function(event) {
			this._stream.write(chunk, encoding, function() {
				event("flushed");
			});
		});
	}
	...
	compress(data, opts = {}) {
		var options = Object.assign({}, this.settings()._settings, opts);
		var name = match_type(options.type);
